    ...
    <body>
        ...
        <?php include 'app/view/toolbar.php' ?>
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h5 class="card-title">About Jhoni Costa</h5>
                    <p class="card-text">Jhoni Regis Souza da Costa, criador do site Desenvolvimento Expert, 
                    Brasileiro natural de Araucária, noivo da Jéssica, Cristão, Tocador de violão e jogador de FIFA nas horas vagas (que estão escassas).</p>
